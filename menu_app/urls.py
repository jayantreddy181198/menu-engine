...
urlpatterns = [
    ...
    path('api/food/get/<str:filter_name>/<str:filter_data>', FoodItemCreateView.as_view(), name='food-item-list'),
    ...
    path('api/bar/get/<str:filter_name>/<str:filter_data>', BarItemCreateView.as_view(), name='bar-item-list'),
